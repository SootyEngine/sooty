...
#signal on_keyval(d_id: String, data: Dictionary)
...
#
#			"array":
#				match line.line.array_type:
#					_: print("GOT ARRAY ", line.line)
#
#			"keyval":
#				if not _execute_mode:
...
#							StringAction.do(a)
#
#					on_keyval.emit(line.d_id, line.line)#DialogueLine.new(line.d_id, line.line))
#
#			_:
